...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		/**
		 * emp3.whoAmI() prints PART TIME EMPLOYEE because the method whoAmI() is
		 * overridden in the PartTimeEmployee class. emp3.getHourlyRate() returns syntax because of dynamic binding
		 *
		 * emp3.getHourlyRate() returns syntax error because the method getHourlyRate() is not defined in the Employee class
		 *
		 */
		...
		// because ...
		/**
		 * This instruction returns a ClassCastException at run time because emp1 is an instance of Employee and not an
		 * instance of PartTimeEmployee. The cast isn't valid because emp1 is not an instance of PartTimeEmployee.
		 */
